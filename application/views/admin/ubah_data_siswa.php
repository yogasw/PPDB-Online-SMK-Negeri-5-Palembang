        ...
        <?php foreach ($data as $u) { ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <div class="form-group label-floating is-empty">
                                ...
                                <input name="nilai_matematika" id="nilai_matematika" type="text" class="form-control"
            ...
            <div class="wizard-footer">
                <div class="pull-right">
                    <input type="button" class="btn btn-next btn-fill btn-<?php rubah_warna() ?> btn-wd" name="next"
                           value="Next">
                    <input type="button" class="btn btn-finish btn-fill btn-<?php rubah_warna() ?> btn-wd" name="finish"
                           id="finish"
