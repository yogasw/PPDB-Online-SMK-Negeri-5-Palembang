        ...
        <div class="col-md-4">
            <div class="card card-pricing ">
                <div class="card-content">
                    ...
                    <h3 class="card-title">Tes Minat dan Bakat</h3>
                    <p class="card-description">
                        Lihat hasil atau edit nilai Tes Minat dan Bakat
                    </p>
        ...
        <div class="col-md-4" hidden>
            <div class="card card-pricing">
                <div class="card-content">
                    ...
                    <h3 class="card-title">Tes Wawancara</h3>
                    <p class="card-description">
                        Lihat hasil atau edit nilai Tes Tes Wawancara
                    </p>
        ...
        <div class="col-md-4" hidden>
            <div class="card card-pricing ">
                <div class="card-content">
                    ...
                    <h3 class="card-title">Tes Psikologi</h3>
                    <p class="card-description">
                        Lihat hasil atau edit nilai Tes Psikologi
                    </p>
